...
#show: content => verbale(
  titoloDocumento: "Lettera di presentazione RTB",
  mittenti: (
...
con la presente lettera il gruppo _Sigma18_ desidera comunicarVi la propria candidatura alla revisione di avanzamento del progetto _Requirements and Technology Baseline (RTB)_ per il capitolato _*C3 - Automatizzare le routine digitali tramite l'intelligenza generativa*_, proposto dall'azienda _*Var Group S.p.A*_.
