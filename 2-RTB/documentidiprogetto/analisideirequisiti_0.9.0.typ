...
=== Utente avanzato
L'utente avanzato è colui che possiede una formazione tale da comprendere il funzionamento di un #glossario("LLM"), pertanto è in grado di sfruttare impostazioni avanzate per un'esperienza d'uso più approfondita e personalizzata. Inoltre, un utente avanzato è in grado di creare automazioni partendo da un flusso vuoto e di modificare quelle esistenti a proprio piacimento.
