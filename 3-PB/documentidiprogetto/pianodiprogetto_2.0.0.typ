...
Aleena Mathew",
    ...
    "Aggiornamento retrospettiva nono sprint e inizio decimo sprint",
    "1.1.0",
    "2025/07/22",
    "Pietro Crotti",
    "Marco Egidi",
...
#table(
  ...
  [Alessandro Bernardello], [0], [0], [3], [2], [0], [0], [*5*],
  [Mirco Borella], [2], [0], [0], [3], [0], [0], [*5*],
  [Pietro Crotti], [3], [0], [0], [2 (-1)], [0], [0], [*5*],
  [Marco Egidi], [0], [0], [0], [3], [0], [2], [*5*],
  [Matteo Marangon], [0], [0], [0], [3], [0], [2], [*5*],
  [Aleena Mathew], [0], [0], [0], [3], [2], [0], [*5*],
  [Carmelo Russello], [0], [0], [3], [2 (-1)], [0], [0], [*5*],
  [*Totali*], [*5*], [*0*], [*6*], [*18*], [*2*], [*4*], [*35*],
)
#pagebreak()
...
#table(
  ...
  [Amministratore], [5], [€20], [€100.00],
  [Analista], [0], [€25], [€0.00],
  [Progettista], [6], [€25], [€150.00],
  [Programmatore], [18], [€15], [€270.00],
  [Responsabile], [2], [€30], [€60.00],
  [Verificatore], [4], [€15], [€60.00],
  [*Totali*], [*35*], [], [*€640.00*],
)

==== *Analisi retrospettiva*: \
_Sigma18_ dichiara che il nono sprint è stato proficuo all'avanzamento del capitolato.

Nello specifico è stata effettuata la revisione RTB con il professor Vardanega, la quale si è conclusa con esito positivo avanzando il gruppo alla fase della _PB (Product Baseline)_.

Il gruppo ha quindi iniziato la fase della _PB (Product Baseline)_ e dello sviluppo del _MVP (Minimum Viable Product)_.

Sono state effettutate delle riflessioni sui ritardi accumulati con la conseguente redazione di una relazione sulle cause e sulle azioni da intraprendere per mitigare quanto riscontrato.
...
*Data di inizio*: 05/08/2025 \
*Data di fine*: 18/08/2025 \

*Rischi attesi*: RT1, RT2, RO1, RO2, RO3

*Attività da svolgere*: \
Il gruppo si impegna a:
- Comprendere e decidere l'implementazione dell'architettura del _MVP (Minimum Viable Product)_.
- Continuare lo sviluppo del _MVP (Minimum Viable Product)_.
- Sviluppo dei test automatici e le loro pratiche d'uso.
- Fare attivitá di "palestra" per comprendere come e cosa vuol dire stendere i documenti di "Manuale Utente" e "Specifica Tecnica".
- Iniziare la stesura del "Manuale Utente" e della "Specifica Tecnica" (fine sprint).
