...
#show: content => presentazione(
  titoloDocumento: "Diario di bordo 2025/06/09",
  content: content,
)
...
- Progressi nello sviluppo del _PoC (Proof of Concept)_ lato _frontend_ e _backend_.
...
- Possibile rallentamento nelle attività riconducibile alla concomitanza con la sessione estiva di esami.
