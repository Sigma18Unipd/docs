...
#show: content => presentazione(
  titoloDocumento: "Diario di bordo 2025/05/05",
  content: content,
)

#spacerS
= Progressi raggiunti e confronto (_retrospettiva_)
- Pianificazione del terzo sprint;
- Stesura delle norme di progetto;
- Stesura del'analisi dei requisiti;
- Stesura del piano di qualifica.
- Aggiornamenti e verifica del #link("https://sigma18unipd.github.io/documentiCompilati/2-RTB/documentidiprogetto/glossario.pdf")[glossario;]
- Continua la stesura e verifica del #link("https://sigma18unipd.github.io/documentiCompilati/2-RTB/documentidiprogetto/pianodiprogetto_0.3.0.pdf")[piano di progetto;]
