...
#show: content => verbale(
  titoloDocumento: "Relazione avanzamento 2025/08/18",
  componenti: (
...
Il gruppo ha inoltre effettuato un importante refactoring del codice _frontend_ e _backend_, al fine di migliorare la sua leggibilità e manutenibilità.
...
- organizzazione della riunione interna di fine _sprint_;
...
Il gruppo ha dovuto effettuare una riunione interna per individuare e studiare i _design pattern_ più adatti per l'architettura, in modo da migliorare la qualità del codice e la manutenibilità del progetto, in modo da poter ultimare al più presto la progettazione software.
