  ...
  align(bottom + center)[
    ...
    #grid(
      ...
      grid.cell(table(
        ...
        align: left,
        table.vline(x: 1),
        ..if type(componenti) == str {
          (align(right + top)[*Partecipanti*], componenti)
        } else {
          (align(right + top)[*Partecipanti*], componenti.join("\n"))
        },
      )),
      grid.cell(table(
        columns: 2,
        ...
        table.vline(x: 1),
        ..if type(gruppo) == str {
          (align(right + top)[*Gruppo*], text(style: "italic", gruppo))
        },
